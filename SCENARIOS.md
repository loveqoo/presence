...
**참고:** 기본 설정에는 calculate 도구가 없습니다. main.js에서 등록하거나, 셸 명령으로 우회할 수 있습니다.
...
**확인:** Plan-then-Execute 대신 ReAct 루프로 동작하는지. 도구를 한 번씩 호출하며 결과를 보고 다음 행동을 결정하는 패턴.
