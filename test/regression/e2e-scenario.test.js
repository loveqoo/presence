...
async function run() {
  ...
  // =============================================
  {
    ...
    const agent = makeTestAgent({ resolveTools: () => tools, interpret, ST, state })
  ...
  // =============================================
  {
    ...
    const agent = makeTestAgent({ maxRetries: 1, interpret, ST })
  ...
  // =============================================
  {
    ...
    const agent = makeTestAgent({ responseFormatMode: 'none', interpret, ST })
