...
| **medium** | 1 | 8 | open: FP-62 / resolved: FP-04, FP-05, FP-06, FP-07, FP-08, FP-09, FP-10, FP-15 |
| **low** | 0 | 4 | resolved: FP-11, FP-12, FP-13, FP-46 |

---

### [FP-62] 심각도: medium | web_fetch 도구 결과 품질 미점검 — 비정상 응답을 LLM 이 정상으로 처리

**영역**: TUI / infra  
**상태**: open  
**관련 코드**: `packages/infra/src/infra/tools/web-fetch.js` (또는 동등 경로), `packages/core/src/core/planner.js`  
**참고**: FP-44 (SERP URL 사전 차단, resolved) — 본 FP 해소 후 FP-44 차단 정책 제거 검토 예정
