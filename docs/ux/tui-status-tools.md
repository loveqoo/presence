...
### [FP-02] 심각도: high | ApprovePrompt.js:7-9 | 승인 거부 후 결과 피드백 없음 — **resolved (2026-04-11)**
...
### [FP-03] 심각도: high | ApprovePrompt.js:12-18 | 위험 수준이 모든 승인 요청에 동일하게 표시됨 — **resolved (2026-04-11)**
...
| 심각도 | 건수 | 항목 |
|--------|------|------|
| **high** | 3 | FP-01, FP-02, FP-03 (FP-14 resolved) |
