...
현재 패턴에 빠진 위험 시나리오가 존재한다. `curl ... | sh`, `chmod 777`, `kill -9`, `git push --force`, `truncate`, `mkfs` 등. 이 항목들은 FP-46으로 별도 등록한다(아래 참조).
...
### [FP-46] 심각도: low | ApprovePrompt.js:8-15 | HIGH_RISK_PATTERNS 커버리지 미흡
...
| 승인 프롬프트 | **보통** | **FP-02, FP-03 해소. 잔여: HIGH_RISK_PATTERNS 커버리지 (FP-46)** |
...
|--------|------|----------|------|
| **high** | 1 | 3 | open: FP-01 / resolved: FP-02, FP-03, FP-14 |
| **medium** | 8 | 0 | FP-04, FP-05, FP-06, FP-07, FP-08, FP-09, FP-10, FP-15 |
| **low** | 4 | 0 | FP-11, FP-12, FP-13, FP-46 (신규) |
