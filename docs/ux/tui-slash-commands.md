...
### [FP-48] 심각도: medium | slash-commands.js:16-44 | `/mcp` 커맨드 피드백이 영어 하드코딩 — **open**
...
### [FP-49] 심각도: low | slash-commands.js:59,61 | `/report` 저장 피드백 영어 하드코딩 — **open**
...
### [FP-51] 심각도: low | App.js:91 | 스트리밍 중 `thinking...` 영어 하드코딩 — **open**
...
| **medium** | 2 | 5 | open: FP-48, FP-50; resolved: FP-38, FP-39, FP-40, FP-41, FP-42 |
| **low** | 2 | 3 | open: FP-49, FP-51; resolved: FP-43, FP-44, FP-45 |
