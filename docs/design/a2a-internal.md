...
**Status**: 2026-04-24 v4. S1 완료 + S2 설계 확정 (Q13 event queue / Q14 UserContext tick / Q15 SYSTEM entry). §4.2 라우팅에 `findSenderSession` (USER+AGENT) 신설, §4.5 todo_response drain 처리, §6.6 expire 클럭 UserContext + race 방어. S2 구현 착수.
