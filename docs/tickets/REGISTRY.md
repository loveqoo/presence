...
| KG-27  | open     | medium | infra  | Cedar 운영자 custom policy 슬롯 (50-*) boot 차단 — staticPolicies 입력 모양 변경으로 정책 식별 가능, P4 unblock 작업 필요 | docs/design/governance-cedar.md#KG-27 |

## 통계

- FP 총 **71개** — open **0**, resolved **71**
- KG 총 **27개** — open **1**, resolved **26**
