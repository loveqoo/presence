...
| KG-08  | open     | medium | tui    | 멀티턴 시 중간 LLM 응답이 TranscriptOverlay에 표시되지 않음      | docs/specs/transcript.md#KG-08                 |

## 통계

- FP 총 **51개** — open **1**, resolved **50**
- KG 총 **8개** — open **1** (KG-08), resolved **7** (KG-01, KG-02, KG-03, KG-04, KG-05, KG-06, KG-07)
- Severity 분포 (open만): high **0**, medium **2** (FP-50, KG-08), low **0**
