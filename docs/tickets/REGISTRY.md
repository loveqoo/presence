...
| FP-55  | open     | medium   | tui  | StatusBar retry 활동 표시 "retry N/M..." 영어 하드코딩          | docs/ux/tui-chat-transcript.md      |
| FP-56  | open     | low      | tui  | Iterations 탭·리포트에 parsedType 등 영어 필드명 직접 노출      | docs/ux/tui-chat-transcript.md      |
...
- FP 총 **58개** — open **2**, resolved **56**
- KG 총 **11개** — open **0**, resolved **11** (KG-01~KG-11)
- Severity 분포 (open만): high **0**, medium **1**, low **1**
