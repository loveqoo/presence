...
- FP 총 **46개** — open **29**, resolved **17** (FP-01, FP-02, FP-03, FP-14, FP-16, FP-17, FP-18, FP-19, FP-20, FP-21, FP-22, FP-24, FP-29, FP-30, FP-36, FP-37, FP-46)
- KG 총 **7개** — open **6**, resolved **1** (KG-07)
- Severity 분포 (open만): high **0**, medium **19**, low **10** (FP) + high **2**, medium **3**, low **1** (KG)
