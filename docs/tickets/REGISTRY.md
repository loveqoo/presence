...
| KG-25  | open     | low    | infra  | Cedar audit JSONL 파일 무한 증가 — rotation policy 부재 (Y' 범위 밖) | docs/design/cedar-infra.md#KG-25 |

## 통계

- FP 총 **67개** — open **0**, resolved **67**
- KG 총 **25개** — open **2**, resolved **23**
- Severity 분포 (open만): low 2 (KG-23 / KG-25)
