...
| FP-46  | open     | low      | tui  | HIGH_RISK_PATTERNS 커버리지 미흡 (curl pipe sh, chmod 777 등) | docs/ux/tui-status-tools.md         |
...
- FP 총 **46개** — open **43**, resolved **3** (FP-02, FP-03, FP-14)
- KG 총 **6개** — 모두 open
- Severity 분포 (open만): high **5**, medium **24**, low **15** (FP) + high **2**, medium **3**, low **1** (KG)
