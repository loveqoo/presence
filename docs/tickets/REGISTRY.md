...
| FP-62  | open     | medium   | tui  | web_fetch 도구 결과 품질 미점검 — 비정상 응답을 LLM 이 정상으로 처리   | docs/ux/tui-status-tools.md         |
...
- FP 총 **62개** — open **1**, resolved **61**
- KG 총 **14개** — open **0**, resolved **14**
- Severity 분포 (open만): medium 1 (FP-62)
