...
| KG-07  | open   | medium   | server | 재연결 중 pending approve Promise 가 서버 측에 hang             | docs/specs/approve.md#E4                       |

## 통계

- FP 총 **46개** — open **42**, resolved **4** (FP-02, FP-03, FP-14, FP-46)
- KG 총 **7개** — 모두 open
- Severity 분포 (open만): high **5**, medium **24**, low **14** (FP) + high **2**, medium **4**, low **1** (KG)
