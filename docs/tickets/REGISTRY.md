...
- FP 총 **46개** — open **12**, resolved **34** (FP-01 ~ FP-07, FP-09, FP-11, FP-12, FP-14, FP-16 ~ FP-22, FP-24 ~ FP-26, FP-29, FP-30, FP-36 ~ FP-46 제외한 나머지 open)
- KG 총 **7개** — open **6**, resolved **1** (KG-07)
- Severity 분포 (open만): high **0**, medium **7**, low **5** (FP) + high **2**, medium **3**, low **1** (KG)
