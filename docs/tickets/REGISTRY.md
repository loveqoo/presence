...
| FP-63  | open     | high     | tui  | WS close 4004 시 원인·조치 미전달 — allowedDirs 위반 메시지 누락       | docs/ux/tui-entry-shell.md          |
| FP-64  | open     | medium   | tui  | /sessions new workingDir 거부 시 영어 서버 에러 노출                   | docs/ux/tui-entry-shell.md          |
...
- FP 총 **64개** — open **2**, resolved **62**
- KG 총 **14개** — open **0**, resolved **14**
- Severity 분포 (open만): high 1 (FP-63), medium 1 (FP-64)
