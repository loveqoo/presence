...
| KG-19  | open     | medium | infra  | JobStore 소유권 필터링 누락 — listJobs/updateJob/deleteJob 가 owner 무시         | docs/specs/agent-identity.md#KG-19 |

## 통계

- FP 총 **66개** — open **0**, resolved **66**
- KG 총 **19개** — open **5**, resolved **14**
- Severity 분포 (open만): high 1 (KG-17) · medium 4 (KG-15, KG-16, KG-18, KG-19)
