...
| KG-28  | open     | medium | infra  | Cedar policy hot reload 부재 — `cmdPolicyReload` 가 stub (재시작 필요). atomic evaluator 교체 + fail-safe rollback + single-flight reload 필요 (P5) | docs/design/governance-cedar.md#KG-28 |

## 통계

- FP 총 **71개** — open **0**, resolved **71**
- KG 총 **28개** — open **1**, resolved **27**
