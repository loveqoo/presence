...
| FP-67  | open     | medium   | infra| A2A 응답 메시지에 내부 에이전트 ID와 "A2A" 용어가 노출됨                | docs/ux/tui-chat-transcript.md      |
...
- FP 총 **67개** — open **1**, resolved **66**
- KG 총 **19개** — open **4**, resolved **15**
- Severity 분포 (open만): high 1 (KG-17) · medium 4 (FP-67, KG-15, KG-16, KG-18)
